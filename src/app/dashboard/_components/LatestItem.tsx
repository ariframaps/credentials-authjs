...
const LatestItem = ({ latest }: { latest: LatestBooking }) => {
	return (
		<div className={`${styles.container}`}>
			...
			<div
				className={`${styles.container__detail2} font-medium text-[14px]`}>
			...
			<div
				className={`${styles.container__detail3} font-medium text-[14px]`}>
				<span className=" text-neutral-secondary">Check-out</span>
				<div>
					<Calendar width={20} height={20} />
					<span className="text-neutral-primary">
			...
			<div
				className={`${styles.container__detail4} font-medium text-[14px]`}>
